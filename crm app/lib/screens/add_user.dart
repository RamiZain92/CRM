...
class AddingUserAgent extends StatefulWidget {
  const AddingUserAgent({super.key, required this.type});
  final String type;

  @override
  _AddingUserAgentState createState() => _AddingUserAgentState();
}

class _AddingUserAgentState extends State<AddingUserAgent> {
                      ...
                      ElevatedButton(
                        ...
                        onPressed: (){
                          if(createKey.currentState!.validate()) {
                            if (widget.type == "user") {
                              MyApp.apis.addUser(userNameController.text,
                                  passwordController.text, _selectedRole).then((
                                  value) {
